...
class PostfixMaps:
    ...
    def __init__(self, module):
        ...
        """
        self.module = module
        self.module.log("PostfixMaps::__init__()")
    ...
    def run(self):
        ...
        runner
        """
        self.module.log("PostfixMaps::run()")
        ...
        for map_data in self.maps:
            ...
            if valid:
                ...
                if _changed:
                    if run_postmap and maps_type in [
                        "btree",
                        "cdb",
                        "dbm",
                        "fail",
                ...
                res[maps_name] = dict(failed=_failed, changed=_changed, msg=_msg)

            else:
                res[maps_name] = dict(failed=True, msg=_msg)
    ...
    def _validate_map(self, map_data):
        ...
        if not maps_name:
            ...
            if not maps_type or maps_type not in [
                "btree",
                "cdb",
                "dbm",
                "fail",
    ...
    def _write_template(self, file_name, data):
        ...
        checksum_file = os.path.join(
            self.cache_directory, "maps", f"{os.path.basename(file_name)}.checksum"
        )
        ...
        changed, checksum, old_checksum = self.checksum.validate(
            checksum_file=checksum_file, data=data
        )
        ...
        self.template.write_template(file_name, TPL_BACKEND, values)
    ...
    def map_data(self, data):
        ...
        """
        self.module.log("PostfixMaps::map_data(data)")
